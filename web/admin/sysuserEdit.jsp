    ...
    <div class="content">
        ...
        <form id="form" name="form" method="post" action="sysuser.do?a=edit">
        	...
        	<div class="form-group">
                <label for="username"><i style="color:red;">*</i>姓名</label>
                <input class="form-control validate[required]" type="text" autocomplete="off" placeholder="请输入姓名" id="username" name="username" />
            </div>
            <div class="form-group">
