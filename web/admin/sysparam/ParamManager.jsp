	...
	<div id="main" role="main">
		...
		<div id="content">
			<div id="easyui-layout" data-options="fit:true">
				<!--<div data-options="region:'north',border:false" style="height:auto;padding:0px;"></div>-->
				<div data-options="region:'west',split:true,title:'参数分类'" style="width:248px;padding:10px;">
					<ul id="dic-tree">
					</ul>
