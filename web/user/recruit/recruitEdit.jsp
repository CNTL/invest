...
<script type="text/javascript" src="script/recruitEdit.js"></script>
</head>
<body>
<div class="content">
	<h1>公司介绍</h1>
	<form class="setting-form" id="form" name="form" action="">
		...
		<div class="form-group form-item">
	        <label for="companyNature"><i style="color:red;">*</i>公司性质：</label>
	        <input class="form-control validate[maxSize[255],required]" type="text" autocomplete="off" id="companyNature" name="companyNature" />
	    </div>
	    <div class="form-group form-item">
		...
		<div class="form-group form-item">
			<label for="content">招聘内容</label><br><br>
		    <script type="text/plain" id="content" name="content" style="margin-left:100px; width:700px;height:100px;"></script>
		</div>
		<div class="form-group form-item">
	        <label for="company">公司全称：</label>
	        <input class="form-control validate[maxSize[255]]" type="text" autocomplete="off" id="company" name="company" />
	    </div>
	    <div class="form-group form-item">
	        <label for="linkman">联系人：</label>
	        <input class="form-control validate[maxSize[255]]" type="text" autocomplete="off" id="linkman" name="linkman" />
	    </div>
	    <div class="form-group form-item">
	        <label for="linkPhone">联系人电话：</label>
	        <input class="form-control validate[maxSize[255]]" type="text" autocomplete="off" id="linkPhone" name="linkPhone" />
	    </div>
	    <div class="form-group form-item">
	        <label for="linkEmail">联系邮箱：</label>
	        <input class="form-control validate[maxSize[255],custom[email]]" type="text" autocomplete="off" id="linkEmail" name="linkEmail" />
	    </div>
