	...
	$.getJSON(url, function(json){
		  if(json.users.length>0){
			  ...
			  $.each(json.users,function(i,n){
				  ...
				  li.append("<a target=\"_blank\" href=\""+webroot+"user/PeopleDetailMain.do?a=detail&mainType=4&id="+n.userid+"&recid="+recid+"\" title=\""+n.username+" 投递于："+n.createtime+"\"><img style=\"width:100px;height:100px;\" src=\""+webroot+n.headurl+"\" alt=\""+n.username+"\" class=\"img-circle\"></a>");
