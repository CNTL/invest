...
<div class="container container-ex">
	...
	<div class="col-md-8">
        <div class="container-right">
        	...
        	<div class="row">
        		<div class="col-md-4">
        			<input type="button" id="createGroup" name="createGroup" class="btn btn-info" value="添加视频组"/>
        	...
        	<div class="row" id="row-form">
        	 <form class="form-horizontal" role="form"  id="form" name="form" action="">
					...
					<div class="form-group">
					    <label for="groupName" class="col-sm-3 control-label">视频组名称：</label>
					    <div class="col-sm-6">
					...
					<div class="form-group">
					    <label for="groupIntro" class="col-sm-3 control-label">描述：</label>
					    <div class="col-sm-6">
					...
					<div class="form-group">
					    <label for="uploadify" class="col-sm-3 control-label">视频组封面：</label>
					    <div class="col-sm-6">
