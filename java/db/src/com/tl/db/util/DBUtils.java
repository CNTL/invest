...
public class DBUtils {
	...
	/**
	 * 工具方法：执行DBSession.executeUpdate(sql, params)操作
	 * 取的是中心数据源
	 * @param sql
	 * @param params
	 * @throws Exception
...
//		execute(0, sql, params);
//	}
	
	/**
	 * 工具方法：执行DBSession.executeUpdate(sql, params)操作
	 * @param dsID 指定执行操作的数据源ID
	 * @param sql
	 * @param params
	 * @throws Exception
	 */
//	public static void execute(int dsID, String sql, Object[] params) throws Exception {
//		DBSession session = null;
//		try {
//			session = (dsID == 0) ? Context.getDBSession() : Context.getDBSession(dsID);
...
//	}
		...
		if ( dbmd != null ) {
			...
			if ( name != null ) {
				...
				for (DBType dbtype : DBType.values()) {
					if(name.indexOf(dbtype.typeName())!=-1)
						return dbtype;
				}
	...
	public static DBType getDbType(DataSource ds) throws SQLException {
